class CalorieTracker {
  ...
  _displayCaloriesRemaining() {
    ...
    if (remaining <= 0) {
      ...
      calorieRemainingEl.parentElement.parentElement.classList.add(
        "text-light"
      );
  ...
  _displayNewMeal(meal) {
    ...
    mealEl.classList.add("card", "my-2", "rounded-4", "border-0", "shadow-lg");
    mealEl.setAttribute("data-id", meal.id);
    mealEl.innerHTML = `
      <div class="card-body">
              <div class="d-flex align-items-center justify-content-between">
                <h4 class="mx-1">${meal.name}</h4>
                <div class="fs-1 bg-primary text-white text-center rounded-4 px-2 px-sm-5">
                  ${meal.calories}
                </div>
                <button class="delete btn text-danger">
    ...
    workoutEl.innerHTML = `
      <div class="card-body">
              <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="fs-1 bg-secondary text-white text-center rounded-4 px-2 px-sm-5">
                  ${workout.calories}
                </div>
                <button class="delete btn text-danger">
                  <i class="fa-solid fa-xmark fs-4"></i>
